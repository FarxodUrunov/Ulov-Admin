...
import { useCarWashForm } from '@/modules/calls/composables/useCarWashModal'
  ...
  >
    <template #body>
      ...
      >
        ...
        <BaseSingleSelect
          id="vehicleType"
          v-model="vehicleType.value.value"
          name="vehicleType"
          :label="t('vehicleType')"
          :options="vehicleTypeList"
          :fieldNames="{ key: 'id', label: 'name' }"
          :success="vehicleType.meta.valid && vehicleType.meta.dirty"
          :error="!vehicleType.meta.valid && !!vehicleType.errorMessage.value"
          :message="vehicleType.errorMessage.value && t(vehicleType.errorMessage.value)"
        />
        <BaseSingleSelect
          id="carWashType"
          v-model="carWashType.value.value"
          name="carWashType"
          :label="t('carWashType')"
          :options="carWashTypeList"
          :fieldNames="{ key: 'id', label: 'name' }"
          :success="carWashType.meta.valid && carWashType.meta.dirty"
          :error="!carWashType.meta.valid && !!carWashType.errorMessage.value"
          :message="carWashType.errorMessage.value && t(carWashType.errorMessage.value)"
        />
        <BaseInput
          id="price"
