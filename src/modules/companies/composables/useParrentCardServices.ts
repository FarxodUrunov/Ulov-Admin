...
export const useParrentCardServices = () => {
  ...
  const { fetchCompaniesAll, deleteCompany, fetchCompanyOne } = store
  const { companiesAllData, loading } = storeToRefs(store)
  ...
  const columns: ColumnType[] = [
    ...
    { minWidth: 240, sort: true, title: 'Название автосервиса', dataIndex: 'name', key: 'id' },
    ...
    { minWidth: 150, sort: true, title: 'Область', dataIndex: 'address', key: 'id' },
