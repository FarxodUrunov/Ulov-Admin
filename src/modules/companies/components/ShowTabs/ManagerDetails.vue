...
import ManagerPostModal from '@/modules/companies/components/ManagerPostModal.vue'
...
const dataSource = [
  ...
  { id: 'service', label: 'Название автосервиса:', value: 'Эвакуацион центр' },
  { id: 'branch', label: 'Филиал автосервиса:', value: 'Эвакуацион центр 2' },
  {
    id: 'address',
    label: 'Адрес:',
...
<template>
  <ManagerPostModal v-model:show="showPostModal" />
