...
import type { MapSettings, MapType, DetailedControls, UpdateFunction } from './types'
...
export default defineComponent({
  ...
  setup(props, { emit, slots, expose }) {
    ...
    const pluginOptions: MapSettings | object =
      (utils.emitter.pluginInstalledGlobal && inject('pluginOptions')) || {}
