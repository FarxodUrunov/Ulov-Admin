...
import { useFuelForm } from '@/modules/calls/composables/useFuelModal'
    ...
    <template #body>
      ...
      >
        ...
        <div class="grid sm:grid-cols-2 gap-4">
          <BaseSingleSelect
            id="fuelGrade"
            v-model="fuelGrade.value.value"
            name="fuelGrade"
            :label="t('fuelGrade')"
            :options="fuelGradeList"
            :fieldNames="{ key: 'id', label: 'name' }"
            :success="fuelGrade.meta.valid && fuelGrade.meta.dirty"
            :error="!fuelGrade.meta.valid && !!fuelGrade.errorMessage.value"
            :message="fuelGrade.errorMessage.value && t(fuelGrade.errorMessage.value)"
          />
          <BaseSingleSelect
            id="quantity"
            ...
            :fieldNames="{ key: 'id', label: 'name' }"
            :success="quantity.meta.valid && quantity.meta.dirty"
            :error="!quantity.meta.valid && !!quantity.errorMessage.value"
            :message="quantity.errorMessage.value && t(quantity.errorMessage.value)"
          />
        </div>
        <BaseDatepicker
          id="datepicker"
