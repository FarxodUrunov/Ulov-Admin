...
<template>
  <div class="block">
    <span v-if="label" class="block text-base font-medium mb-1.5">{{ label }}</span>
    <div class="relative inline-flex">
      ...
      >
        <BaseIcon
          ...
          name="rating"
          class="inline-block text-yellow-dark first:ml-0 last:mr-0"
          :class="[sizeVariant.icon, hoverState, disabledState]"
          viewBox="-1 0 22 20"
          v-on="!disabled ? { click: () => handleStarClick(i) } : {}"
        />
